...
const ConsentForm = () => {
  const apiUrl = `${process.env.REACT_APP_APIENDPOINTNEW}user/submitConsent`;
        ...
        .then((res) => {
          ...
          if (res?.data.message === "Data Submitted") {
            swal({
              ...
              text: "This service will start shorlty!",
              icon: "success",
              button: "Go Back",
            }).then((res) => {
              navigate("/app/home");
        ...
        <div
          ...
          style={{
            backgroundImage: banner
              ? `url(${banner})`
              : `url(${require("../../assets/img/verification_bg.jpg")})`,
          }}>
          <section className="">
              ...
              <div
                ...
                <div className="col-lg-7 col-md-6 ">
                  <div class="form-container">
                    <div class="form">
                      <span class="heading">Consent Form</span>
                        ...
                        <Shake when={Err}>
                          <p className="d-flex">
                            ...
                            <input
                              id="check"
                              type="checkbox"
                              class="form-check-consent"
                              onChange={(e) => setCheck(e.target.checked)}
                            />
                            Text me with Shipping and Order updates.
                          </p>
                        </Shake>
                      </div>
                      ...
                      <div class="button-container mt-4">
                        <div class="send-button" onClick={() => onSubmit()}>
                          Submit
                        </div>
